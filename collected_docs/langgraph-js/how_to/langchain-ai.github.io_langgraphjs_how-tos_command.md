- How to combine control flow and state updates with Command [Skip to content](#how-to-combine-control-flow-and-state-updates-with-command) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)

- Guides

- [How to create and control loops](../recursion-limit/)
...
This guide assumes familiarity with the following: - [State](/langgraphjs/concepts/low_level/#state) - [Nodes](/langgraphjs/concepts/low_level/#nodes) - [Edges](/langgraphjs/concepts/low_level/#edges) - [Command](/langgraphjs/concepts/low_level/#command) This functionality also requires `@langchain/langgraph>=0.2.29`.
