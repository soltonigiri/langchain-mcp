- How to use the prebuilt ReAct agent [Skip to content](#how-to-use-the-prebuilt-react-agent) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)
