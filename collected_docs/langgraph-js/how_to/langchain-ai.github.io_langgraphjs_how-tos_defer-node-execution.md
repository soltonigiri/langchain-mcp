- How to defer node execution [Skip to content](#how-to-defer-node-execution) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)
...
[How to defer node execution¶](#how-to-defer-node-execution)

Prerequisites

This guide assumes familiarity with the following: - [Graphs](/langgraphjs/concepts/low_level/#graphs) - [Nodes](/langgraphjs/concepts/low_level/#nodes) - [Edges](/langgraphjs/concepts/low_level/#edges)
