- How to build a multi-agent network [Skip to content](#how-to-build-a-multi-agent-network) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)
...
[How to build a multi-agent network¶](#how-to-build-a-multi-agent-network)

Prerequisites

This guide assumes familiarity with the following: - [Nodes](/langgraphjs/concepts/low_level/#nodes) - [Command](/langgraphjs/concepts/low_level/#command) - [Multi-agent systems](/langgraphjs/concepts/multi_agent) This functionality also requires `@langchain/langgraph>=0.2.29`.
...
## Game NPCs Example[¶](#game-npcs-example)
