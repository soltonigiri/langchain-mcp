- How to handle tool calling errors [Skip to content](#how-to-handle-tool-calling-errors) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)
...
[How to handle tool calling errors¶](#how-to-handle-tool-calling-errors)
...
This guide requires `@langchain/langgraph>=0.0.28`, `@langchain/anthropic>=0.2.6`, and `@langchain/core>=0.2.17`. For help upgrading, see [this guide](/langgraphjs/how-tos/manage-ecosystem-dependencies/).

## Using the prebuilt ToolNode[¶](#using-the-prebuilt-toolnode)
