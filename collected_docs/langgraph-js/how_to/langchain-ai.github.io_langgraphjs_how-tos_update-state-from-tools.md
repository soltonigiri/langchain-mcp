- How to update graph state from tools [Skip to content](#how-to-update-graph-state-from-tools) Initializing search [GitHub](https://github.com/langchain-ai/langgraphjs)
