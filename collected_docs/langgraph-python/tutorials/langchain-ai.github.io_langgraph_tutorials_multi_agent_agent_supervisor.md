...
Let's [run the agent](../../../agents/run_agents/) to verify that it behaves as expected.
...
## 2. Create supervisor with langgraph-supervisor[¶](#2-create-supervisor-with-langgraph-supervisor)
